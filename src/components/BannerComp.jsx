...
export default function BannerComp() {
  ...
  return (
    <Banner className="px-10 mb-6">
      <div className="flex w-full flex-col justify-between border-b border-gray-200 bg-gray-50 p-4 md:flex-row dark:border-gray-600 dark:bg-gray-700 mt-2 rounded-2xl">
